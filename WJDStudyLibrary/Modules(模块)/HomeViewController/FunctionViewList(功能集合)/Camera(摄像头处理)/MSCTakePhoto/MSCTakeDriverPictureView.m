...
@interface MSCTakeDriverPictureView ()
...
@implementation MSCTakeDriverPictureView
...
- (void)makeupUI
{
    ...
    self.detailLabel.text = @"将行驶证放入虚线框内，亮度均匀";
