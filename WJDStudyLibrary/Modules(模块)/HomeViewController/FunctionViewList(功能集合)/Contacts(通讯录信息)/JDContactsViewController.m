...
- (void)viewDidLoad {
    ...
    UIButton *button =[JDUIFactory createButtonWithFrame:CGRectMake(SCREEN_WIDHT-100, SCREEN_HEIGHT-100, 80, 80) ImageName:nil Target:self Action:@selector(addPersion) Title:@"添加"];
