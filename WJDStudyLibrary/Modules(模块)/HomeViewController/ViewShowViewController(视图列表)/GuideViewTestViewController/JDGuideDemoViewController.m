...
- (void)createUI {
    ...
    UIButton *button =[JDUIFactory createButtonWithFrame:CGRectMake(SCREEN_WIDHT-100, SCREEN_HEIGHT-50, 80, 30) ImageName:nil Target:self Action:@selector(onceMore) Title:@"再看一遍!"];
