...
+(void)showMessage:(NSString *)message withView:(UIView *)view
{
    ...
    UIView *showView =[JDUIFactory createViewWithFrame:CGRectMake(0, 0, SCREEN_WIDHT, StatusBar_HEIGHT)];
    ...
    UILabel *messageLabel =[JDUIFactory createLabelWithFrame:CGRectMake(0, 0, SCREEN_WIDHT, StatusBar_HEIGHT) FontSize:12 Text:message];
